  ...
  useEffect(()=>{
    ...
    <Dropdown>
      ...
      <Dropdown.Menu className={styles.menu}>
        ...
        <Dropdown.Item onClick={()=>updateLanguage(Countries.FRANCE)} className='d-flex justify-content-between'>
        ...
        <Dropdown.Item onClick={()=>updateLanguage(Countries.GREAT_BRITAIN)} className='d-flex justify-content-between'>
