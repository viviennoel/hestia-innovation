...
const Designs = () => {
  ...
  const contentHighlight = [
    ...
    },
    {
        ...
        link:'/articles?article=green-it-opportunity-and-accessibility',
        delay:'300'
    },
    {
        ...
        link:'/articles?article=modeling-3D-immersive',
        delay:'600'
    }
  ]
  ...
  return (
    <>
      <div style={{minHeight: '100vh'}}>
        <BannerDesign />
        <Container>
          <h3 className={styles.title}>{translations[language].designs.title}</h3>
        </Container>
