...
interface HeaderDocumentData {
    /**
     * link field in *header*
     *
     * - **Field Type**: Link
     * - **Placeholder**: *None*
     * - **API ID Path**: header.link
     * - **Tab**: Main
...
export type AllDocumentTypes = ArticleDocument | HeaderDocument | NavigationDocument | PageDocument | SettingsDocument;
/**
